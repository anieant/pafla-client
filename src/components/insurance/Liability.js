                    ...
                    <Row>
                            ...
                            <div className={styles.about_text}>
                                <div className={styles.card_item}>
                                    ...
                                    <Paragraph className="section-text">
                                        ...
                                        Get a fast, free quote now and get that PAFLA confidence behind your consulting/
                                        freelance business. If you prefer, you can call us at <b>1-866-283-7545</b> and
                                        speak
                        ...
                        <Col xs={{span: 24}}>
                            <div className="liability-shop">
                                {shop.map(sh => <InsuranceCard image={sh.image} title={sh.title} text={sh.text} link={sh.link}/>)}
